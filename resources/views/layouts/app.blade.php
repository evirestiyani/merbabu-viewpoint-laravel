...
<body class="bg-gray-50 font-inter">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden lg:flex items-center space-x-8">
                    <a href="{{ route('home') }}" class="nav-link text-gray-700 hover:text-green-600 font-medium transition-colors duration-200 relative {{ Request::routeIs('home') ? 'text-green-600' : '' }}">
                        Beranda
                        @if(Request::routeIs('home'))
                            <span class="absolute -bottom-1 left-0 w-full h-0.5 bg-green-600 rounded-full"></span>
                        @endif
                    </a>
                   <a href="#" class="nav-link text-gray-700 hover:text-green-600 font-medium transition-colors duration-200 relative {{ Request::routeIs('about') ? 'text-green-600' : '' }}">
                        Tentang
                        @if(Request::routeIs('about'))
                            <span class="absolute -bottom-1 left-0 w-full h-0.5 bg-green-600 rounded-full"></span>
                        @endif
                    </a>
                      <a href="#" class="nav-link text-gray-700 hover:text-green-600 font-medium transition-colors duration-200 relative {{ Request::routeIs('gallery') ? 'text-green-600' : '' }}">
                        Galeri
                        @if(Request::routeIs('gallery'))
                            <span class="absolute -bottom-1 left-0 w-full h-0.5 bg-green-600 rounded-full"></span>
                        @endif
                    </a>
                    <a href="#" class="nav-link text-gray-700 hover:text-green-600 font-medium transition-colors duration-200 relative {{ Request::routeIs('posts.*') ? 'text-green-600' : '' }}">
                        Artikel
                        @if(Request::routeIs('posts.*'))
                            <span class="absolute -bottom-1 left-0 w-full h-0.5 bg-green-600 rounded-full"></span>
                        @endif
                    </a>
                    <a href="{{ route('contact') }}" class="bg-gradient-to-r from-green-600 to-blue-600 text-white px-6 py-2 rounded-full font-medium hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                        Kontak
                    </a>
                </div>
                ...
                <!-- Mobile menu button -->
                <div class="lg:hidden">
                    <button id="mobile-menu-button" class="text-gray-700 hover:text-green-600 transition-colors duration-200">
            ...
            <div id="mobile-menu" class="hidden lg:hidden pb-4 border-t border-gray-200 mt-4">
                <div class="space-y-3 pt-4">
                    ...
                    <a href="{{ route('about') }}" class="block text-gray-700 hover:text-green-600 font-medium py-2 px-3 rounded-lg hover:bg-green-50 transition-all duration-200 {{ Request::routeIs('about') ? 'text-green-600 bg-green-50' : '' }}">
                        <div class="flex items-center space-x-3">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                   ...
                   <a href="#artikel" class="block text-gray-700 hover:text-green-600 font-medium py-2 px-3 rounded-lg hover:bg-green-50 transition-all duration-200 {{ Request::routeIs('posts.*') ? 'text-green-600 bg-green-50' : '' }}">
                        <div class="flex items-center space-x-3">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('gallery') }}" class="block text-gray-700 hover:text-green-600 font-medium py-2 px-3 rounded-lg hover:bg-green-50 transition-all duration-200 {{ Request::routeIs('gallery') ? 'text-green-600 bg-green-50' : '' }}">
                        <div class="flex items-center space-x-3">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('contact') }}" class="block text-gray-700 hover:text-green-600 font-medium py-2 px-3 rounded-lg hover:bg-green-50 transition-all duration-200 {{ Request::routeIs('contact') ? 'text-green-600 bg-green-50' : '' }}">
                        <div class="flex items-center space-x-3">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Back to Top Button -->
    <button id="back-to-top" class="btn-floating bg-gradient-to-r from-green-600 to-blue-600 text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110">
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="flex space-x-4">
                        <a href="#" class="bg-gray-800 hover:bg-gray-700 p-3 rounded-lg transition-all duration-300 transform hover:scale-110">
                        ...
                        <a href="#" class="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 p-3 rounded-lg transition-all duration-300 transform hover:scale-110">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="{{ route('home') }}" class="text-gray-300 hover:text-white transition-colors duration-200 flex items-center space-x-2 group">
                                <span class="w-1 h-1 bg-green-600 rounded-full group-hover:w-2 transition-all duration-200"></span>
                                <span>Beranda</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('about') }}" class="text-gray-300 hover:text-white transition-colors duration-200 flex items-center space-x-2 group">
                                <span class="w-1 h-1 bg-green-600 rounded-full group-hover:w-2 transition-all duration-200"></span>
                        ...
                        <li>
                            <a href="{{ route('gallery') }}" class="text-gray-300 hover:text-white transition-colors duration-200 flex items-center space-x-2 group">
                                <span class="w-1 h-1 bg-green-600 rounded-full group-hover:w-2 transition-all duration-200"></span>
