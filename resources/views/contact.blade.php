...
@section('content')
    ...
    <!-- Call to Action -->
    <section class="py-24 bg-gradient-to-br from-green-600 via-emerald-600 to-teal-600 relative overflow-hidden">
        <!-- Background Effects -->
        <div class="absolute inset-0">
            <div class="absolute top-10 left-10 w-20 h-20 bg-white/10 rounded-full blur-xl"></div>
            <div class="absolute bottom-20 right-20 w-32 h-32 bg-white/5 rounded-full blur-2xl"></div>
            <div
                class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-white/5 rounded-full blur-3xl">
            </div>
        </div>

        <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
            <h3 class="text-4xl md:text-5xl font-black text-white mb-6 leading-tight">
                Siap Menaklukkan <span class="text-yellow-300">Merbabu?</span>
            </h3>
            <p class="text-xl text-green-100 mb-12 leading-relaxed max-w-2xl mx-auto">
                Hubungi kami sekarang untuk merencanakan petualangan pendakian yang tak terlupakan bersama tim guide
                berpengalaman
            </p>

            <div class="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <a href="https://wa.me/6281234567890"
                    class="inline-flex items-center space-x-3 bg-white text-green-600 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-green-50 transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        <path
                ...
                <a href="tel:+6281234567890"
                    class="inline-flex items-center space-x-3 border-2 border-white text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white hover:text-green-600 transition-all duration-300 transform hover:scale-105">
